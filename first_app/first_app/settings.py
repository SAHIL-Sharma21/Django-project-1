...
SECRET_KEY = 'django-insecure-h&a$t(x_$yc0rhmjv3cjdd*4z*ugi)-fc@n^3kd7p49o54s@kx'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  #this is used to server static css file important line
